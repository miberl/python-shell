...
class TestLs(TestSetup):
    ...
    def test_read_current_dir(self):
        self.run_test_no_order("ls", ["test.txt", "dir2", "dir1", "quotes.txt"])

    # ls in specified dir
    def test_read_dir_1(self):
        self.run_test_no_order(
            "ls dir1", [ "file1.txt", "file2.txt","file3.txt","file4.txt", "longfile.txt", "subdir"]
        )

    # check for secret files
    def test_read_dir_with_hidden_not_shown(self):
        self.run_test_no_order("ls dir1/subdir", ["normal"])
