...
class TestEvalInstructions(TestSetup):
    ...
    def test_eval_many_instructions(self):
        args = [self.instruction, self.instruction2]
        self.run_test(args, ["hello\n", "there\n"])

    def test_input_redirection(self):
        self.run_test(
            [self.redirected_input_instruction],
            ["CCC\n"],
    ...
    def test_output_redirection(self):
        ...
        self.run_test(
            [self.redirected_output_instruction],
            [],
            "application.Application.write_lines",
            TestSetup.mock_write_lines,
        )
