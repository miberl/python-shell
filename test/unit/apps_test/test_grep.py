...
class TestGrep(TestSetup):
    ...
    def test_grep_file(self):
        self.run_test("grep AAA dir1/file1.txt",
                      ["AAA", "AAA"], split_on_newline=True)
    ...
    def test_grep_multiple_files(self):
        self.run_test("grep AAA dir1/file1.txt dir1/file2.txt",
                      ["dir1/file1.txt:AAA", "dir1/file1.txt:AAA"], split_on_newline=True)

    def test_grep_subdir_multiple_files(self):
        self.run_test("grep AAA dir1/file1.txt dir2/subdir/file.txt",
                      ["dir1/file1.txt:AAA", "dir1/file1.txt:AAA", "dir2/subdir/file.txt:AAA", "dir2/subdir/file.txt:AAA"], split_on_newline=True)
